...
<script lang="ts">
	...
	const teamMember: TeamMember = {
		name: "Jordan Blake",
		role: "Founder & CEO",
		image: "/generated/image-a-professional-business-founder-in-a-mod.webp"
	};
</script>
	...
	<div class="section-px section-py container mx-auto">
		<div class="relative mx-auto grid max-w-2xl place-items-center gap-16">
			<ScrollText
				...
				text={`"I watched brilliant RevOps teams spend 20+ hours every week fixing broken integrations instead of driving growth. That's when I realized we needed to reimagine the entire GTM stack—not as fragmented tools, but as one unified orchestration platform."`}
			/>
